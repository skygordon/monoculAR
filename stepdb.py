...
def insertstart1():
    conn = sqlite3.connect(visits_db)
    c = conn.cursor()
    c.execute('''INSERT into step_table VALUES (?,?,?);''', (12 , 1, pd.datetime.now().month))
    conn.commit()
    conn.close()
insertstart1()
...
def insertstart2():
    conn = sqlite3.connect(visits_db)
    c = conn.cursor()
    c.execute('''INSERT into step_table VALUES (?,?,?);''', (78 , 2, pd.datetime.now().month))
    conn.commit()
    conn.close()
insertstart2()
...
def insertstart3():
    conn = sqlite3.connect(visits_db)
    c = conn.cursor()
    c.execute('''INSERT into step_table VALUES (?,?,?);''', (204 , 3, pd.datetime.now().month))
    conn.commit()
    conn.close()
insertstart3()
#
